export default function PrivacyPolicies() {
  return (
    <div className="container page-privacy mx-auto py-8">
      <>
        <style
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">June 15, 2022</bdt>
                  </span>
                </span>
              </strong>
            </span>
            ...
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">Ming Inc</bdt>
          ...
          <div>
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: 'rgb(127, 127, 127)' }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="question">rainkolwa@gmail.com</bdt>.
                  </span>
                </span>
              </span>
            </div>
            ...
            <div style={{ lineHeight: '1.5' }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="https://records-roan.vercel.app/profile"
                      target="_blank"
                      data-custom-class="link"
                      rel="noreferrer"
                    >
                      https://records-roan.vercel.app/profile
                    </a>
                  </bdt>
            ...
            <ul>
              <li style={{ lineHeight: '1.5' }}>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <bdt className="question">health data</bdt>
                  </span>
                </span>
              </li>
            </ul>
